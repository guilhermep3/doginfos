...
export const HeroSection = () => {
  ...
  return (
    <section id="hero" className="h-screen bg-zinc-100">
      <div className={containerStyle + ' flex flex-col md:gap-6 lg:flex-row h-full pb-0 md:pb-0 overflow-hidden'}>
        ...
        <div className="relative md:flex-1 flex items-end">
          ...
          <div className="absolute -bottom-4 bg-blue-900 left-1/2 -translate-x-1/2 w-4/5 h-4/5 max-w-[480px] max-h-[480px] rounded-[64px] rotate-12"></div>
          <div className="absolute -bottom-10 bg-[var(--caramel)] left-1/2 -translate-x-1/2 w-4/5 h-4/5 max-w-[520px] max-h-[520px] rounded-4xl rotate-[30deg]"></div>
          <div className="w-11/12 md:w-full z-[1]">
